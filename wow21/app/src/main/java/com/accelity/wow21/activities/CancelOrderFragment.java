...
public class CancelOrderFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        allOrder = fgh.getOrders(2);
        rvOrder = (RecyclerView)getActivity().findViewById(R.id.recycleview_cancelOrderList);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View fragmentView = inflater.inflate(R.layout.fragment_cancel_order, container, false);
        layoutManager = new LinearLayoutManager(getActivity());
        rvOrder = (RecyclerView)fragmentView.findViewById(R.id.recycleview_cancelOrderList);
        ...
        protected void onPostExecute(String responseData) {
            ...
            if(orderListObject != null){
                if(orderListObject.length() > 0){
                    ...
                    Toast.makeText(getActivity(), CustMessages.getNoOrderHist(getContext()), Toast.LENGTH_LONG).show();
                }
            }
        }
    }
