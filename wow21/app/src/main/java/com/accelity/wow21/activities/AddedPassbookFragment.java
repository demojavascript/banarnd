...
public class AddedPassbookFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View fragmentView = inflater.inflate(R.layout.fragment_added_passbook, container, false);
        ...
        protected void onPostExecute(String responseData) {
            ...
            if(passBookObject != null){
                if(passBookObject.length() > 0){
                    ...
                    Toast.makeText(getActivity(), CustMessages.getNoTransHistory(getContext()), Toast.LENGTH_LONG).show();
                }
            }
        }
    }
