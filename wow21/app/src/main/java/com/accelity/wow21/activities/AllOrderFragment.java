...
public class AllOrderFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        allOrder = fgh.getOrders(0);
        rvOrder = (RecyclerView)getActivity().findViewById(R.id.recycleview_allOrderList);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View fragmentView = inflater.inflate(R.layout.fragment_all_order, container, false);
        layoutManager = new LinearLayoutManager(getActivity());
        rvOrder = (RecyclerView)fragmentView.findViewById(R.id.recycleview_allOrderList);
